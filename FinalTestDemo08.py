...
class LoginApp:
    def __init__(self, master):
        ...
        self.login_button = tk.Button(self.login_frame, text="Loginway", command=self.login, bg="DarkSeaGreen", fg="LightGoldenrodYellow", font=("Helvetica", 20, "bold"), padx=111, pady=5)
    ...
    def open_camera(self):
        ...
        # 添加退出按钮
        self.exit_button = tk.Button(self.log_frame, text="退出", command=self.exit_camera, bg="DarkRed", fg="LightGoldenrodYellow", font=("Helvetica", 20, "bold"))
